...
export default {
  ...
  validations: {
    meetingFormData: {
      ...
      additionalInfo: { maxLength: maxLength(1000), validationalRequirements },
    },
  },
  data: () => ({
    isReady: false,
  ...
  computed: {
    ...
    nameErrors() {
      ...
      !this.$v.meetingFormData.name.maxLength &&
        errors.push(this.lang.NAME_MUST_BE_NO_MORE_THAN_50_CHARACTERS_LONG);
    ...
    additionalInfoErrors() {
      ...
      !this.$v.meetingFormData.additionalInfo.maxLength &&
        errors.push(this.lang.INFO_MUST_BE_NO_MORE_THAN_1000_CHARACTERS_LONG);
