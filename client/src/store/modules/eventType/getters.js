...
export default {
    ...
    [types.GET_VISIBLE_AVAILABILITY_DIALOG]: state => state.visibleAvailabilityDialog,
    [types.GET_VISIBLE_TIME_ZONE_DIALOG]: state => state.visibleTimeZoneDialog,
    [types.GET_VISIBLE_DAY_AVAILABILITIES_DIALOG]: state => state.visibleDayAvailabilitiesDialog,
