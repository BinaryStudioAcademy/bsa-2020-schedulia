export default {
    ...
    CALENDAR_INVITATION_HAS_BEEN_SENT:
        'Запрошення до календаря надіслано на вашу електронну пошту',
    CANCEL: 'Скасувати',
    ...
    EXPLANATION_ERROR_PASSWORD_RESET:
        'Час дії токена минув або ви не скопіювали весь запит. Перейдіть на сторінку скидання пароля і знову надішліть запит на скидання з коректною електронною поштою',
    ...
    LETTER_EXPLANATION_EMAIL_DONOT_EXIST:
        'Перевірте, чи використовували ви цю електронну пошту під час реєстрації. Введіть правильну і спробуйте ще раз.',
    LETTER_EXPLANATION_EMAIL_EXIST:
        'Перевірте вказану електронну пошту. Ви отримаєте лист із посиланням, натиснувши на яке Ви зможете змінити свій пароль.',
    LETTER_WITH_RESET_LINK_WAS_SENT:
        'Лист із посиланням для скидання був надісланий на вашу електронну пошту',
    ...
    YOU_LOG_IN_WITH_AN_EMAIL_ADDRESS: 'Ви входите з електронною поштою:',
    ...
    CONNECT_YOUR_CALENDAR_TEXT:
        'Підключіть свій календар, щоб повідомити Schedulia, коли ви доступні, та автоматіично додавати заплановані події.',
    ...
    INVITEE_EMAILS: 'Єлектронная пошта',
    ALL_INVITEE_EMAILS: 'Вибрати усі електронні пошти',
    ...
    INCLUDE_WHALE_MEETING:
        'Автоматично підключайте Whale мітинги в Schedulia. Щоб користуватися Whale, вам потрібно зареєструватися за тією самою електронною поштою.',
